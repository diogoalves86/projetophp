...
--
-- Host: localhost
-- Generation Time: Nov 22, 2015 at 04:35 PM
...
(26, 8, 8, 5, NULL, NULL, 7, 5, 6),
(27, 9, 2, 5, NULL, NULL, 10, 5, 12),
(28, 9, 4, 6, NULL, NULL, NULL, 5, 9),
(29, 10, 10, 5, NULL, NULL, 6, 5, 8),
(30, 10, 2, 2, NULL, 6, 6, 6, 12);
...
--
ALTER TABLE `Comentario`
  ADD CONSTRAINT `Comentario_ibfk_1` FOREIGN KEY (`aluno_id`) REFERENCES `Usuario` (`id`),
  ADD CONSTRAINT `Comentario_ibfk_2` FOREIGN KEY (`professor_id`) REFERENCES `Usuario` (`id`);
